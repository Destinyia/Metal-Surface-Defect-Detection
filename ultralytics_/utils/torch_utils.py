...
def get_cpu_info():
    ...
    from ultralytics_.utils import PERSISTENT_CACHE  # avoid circular import error
...
def strip_optimizer(f: Union[str, Path] = "best.pt", s: str = "", updates: dict = None) -> dict:
    ...
    Example:
        ```python
        from pathlib import Path
        from ultralytics_.utils.torch_utils import strip_optimizer
...
def profile(input, ops, n=10, device=None):
    ...
    Example:
        ```python
        from ultralytics_.utils.torch_utils import profile
