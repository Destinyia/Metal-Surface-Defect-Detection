...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Example:
        ```python
        from ultralytics_.utils.checks import parse_requirements
...
def check_pip_update_available():
    ...
    if ONLINE and IS_PIP_PACKAGE:
        try:
            from ultralytics_ import __version__
...
def check_yolo(verbose=True, device=""):
    ...
    from ultralytics_.utils.torch_utils import select_device
...
def collect_system_info():
    ...
    from ultralytics_.utils import ENVIRONMENT  # scope to avoid circular import
    from ultralytics_.utils.torch_utils import get_cpu_info, get_gpu_info
...
def check_amp(model):
    ...
    Example:
        ...
        from ultralytics_.utils.checks import check_amp
    ...
    """
    from ultralytics_.utils.torch_utils import autocast
