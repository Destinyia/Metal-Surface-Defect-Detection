...
Usage:
    from ultralytics_.utils.benchmarks import ProfileModels, benchmark
...
from ultralytics_.cfg import TASK2DATA, TASK2METRIC
from ultralytics_.engine.exporter import export_formats
from ultralytics_.utils import ARM64, ASSETS, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from ultralytics_.utils.checks import IS_PYTHON_3_12, check_requirements, check_yolo
from ultralytics_.utils.downloads import safe_download
from ultralytics_.utils.files import file_size
from ultralytics_.utils.torch_utils import get_cpu_info, select_device
...
def benchmark(
    ...
    Examples:
        ...
        >>> from ultralytics_.utils.benchmarks import benchmark
...
class ProfileModels:
    ...
    Examples:
        ...
        >>> from ultralytics_.utils.benchmarks import ProfileModels
