...
def spaces_in_path(path):
    ...
    Examples:
        ...
        >>> from ultralytics_.utils.files import spaces_in_path
...
def update_models(model_names=("yolo11n.pt",), source_dir=Path("."), update_names=False):
    ...
    Examples:
        ...
        >>> from ultralytics_.utils.files import update_models
        >>> model_names = ("yolo11n.pt", "yolov8s.pt")
        >>> update_models(model_names, source_dir=Path("/models"), update_names=True)
    """
    from ultralytics import YOLO
    from ultralytics_.nn.autobackend import default_class_names
