...
from ultralytics_.data.utils import polygons2masks, polygons2masks_overlap
from ultralytics_.utils import LOGGER, colorstr
from ultralytics_.utils.checks import check_version
from ultralytics_.utils.instance import Instances
from ultralytics_.utils.metrics import bbox_ioa
from ultralytics_.utils.ops import segment2box, xyxyxyxy2xywhr
from ultralytics_.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class Compose:
    ...
    def __init__(self, transforms):
        ...
        Examples:
            >>> from ultralytics_.data.augment import Compose, RandomHSV, RandomFlip
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics_.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics_.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
    ...
    def __init__(self, dataset, pre_transform=None, p=0.0) -> None:
        ...
        Examples:
            >>> from ultralytics_.data.dataset import YOLODataset
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from ultralytics_.data.augment import RandomHSV
...
class CopyPaste(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics_.data.augment import CopyPaste
        >>> dataset = YourDataset(...)  # Your image dataset
