...
from ultralytics_.utils import DATASETS_DIR, LOGGER, NUM_THREADS, TQDM
from ultralytics_.utils.downloads import download
from ultralytics_.utils.files import increment_path
...
def convert_coco(
    ...
    Example:
        ```python
        from ultralytics_.data.converter import convert_coco
...
def convert_segment_masks_to_yolo_seg(masks_dir, output_dir, classes):
    ...
    Example:
        ```python
        from ultralytics_.data.converter import convert_segment_masks_to_yolo_seg
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    Example:
        ```python
        from ultralytics_.data.converter import convert_dota_to_yolo_obb
...
def yolo_bbox2segment(im_dir, save_dir=None, sam_model="sam_b.pt"):
    ...
    from ultralytics_.utils import LOGGER
...
def create_synthetic_coco_dataset():
    ...
    Examples:
        >>> from ultralytics_.data.converter import create_synthetic_coco_dataset
